...
aimset_import_file = None # The imported file (with pointing angles), so it does not perform the recalculation
aimset_aim_object = None
aimset_solve_method='solve'
